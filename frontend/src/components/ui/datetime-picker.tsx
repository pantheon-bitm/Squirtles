...
type LocaleWithCode = Locale & { code: string };
 ...
 */
export const parseDateTime = (str: Date | string, locale: LocaleWithCode) => {
    ...
    return (
      ...
      >
        <div className="flex items-center justify-center">
          ...
          >
            <DateTimeLocalInput
              locale={locale as LocaleWithCode}
              hour12={hour12}
              disabled={disabled}
              {...dateTimeInputProps}
            />
...
const DateTimeLocalInput = ({
  ...
  const formateSelectedDate = (selectedDate: Date | undefined) => {
